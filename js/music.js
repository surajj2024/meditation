...
volumeSlider.addEventListener("input", () => {
  ...
  const track = volumeSlider.querySelector(".slider-track");

  if (value <= 15) {
    changeBgTo("#A333C8 ");
    track.style.background =
      "linear-gradient(to right, #B363C8 " +
      value +
      "%, transparent " +
      value +
      "%)";
    ...
    changeBgTo("#2185D0");
    track.style.background =
      "linear-gradient(to right, #111500 " +
      value +
      "%, transparent " +
      value +
      "%)";
    ...
    changeBgTo("#6435C9");
    track.style.background =
      "linear-gradient(to right, #6435C9 " +
      value +
      "%, transparent " +
      value +
      "%)";
    ...
    changeBgTo("#21BA45");
    track.style.background =
      "linear-gradient(to right, #21BA45 " +
      value +
      "%, transparent " +
      value +
      "%)";
    ...
    changeBgTo("#FBBD08");
    track.style.background =
      "linear-gradient(to right, #AAB008 " +
      value +
      "%, transparent " +
      value +
      "%)";
    ...
    changeBgTo("#DB1868");
    track.style.background =
      "linear-gradient(to right, #DB2828 " +
      value +
      "%, transparent " +
      value +
      "%)";
  ...
  volumeSlider.style.boxShadow = "0 2px 15px rgba(0,0,0,0.3)";
});
